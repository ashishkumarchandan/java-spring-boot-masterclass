...
| :--- | :--- | :--- | :---: | :--- |
| **Week 1** | **Spring Core & Spring Boot Bootstrap** | IoC Container, Bean Lifecycle, Scopes, Dependency Injection, Maven, Autoconfiguration | 🟢 Active | [Go to Week 1](./week1/) (12 Sub-projects) |
| **Week 2** | *Spring Data JPA & Hibernate* | Entity Mapping, JPQL, Repositories, Transactions, Auditing | 🟡 Up Next | *TBD* |
